...
<body class="vertical-layout vertical-menu-modern content-left-sidebar chat-application navbar-floating footer-static  "
    ...
    <div class="app-content content" style="margin-left:0px;display:flex;">
                        ...
                        <div id="users-list" class="chat-user-list list-group position-relative">
                            ...
                            <ul class="chat-users-list-wrapper media-list">
                                ...
                                @foreach ($approve_msgs as $msg)
                                    ...
                                    <a href="/super/chat?id={{ $msg->id }}" style="color:black" class="a_tag">
        ...
        <div class="request">
            <div class="box">
                    <div class="data">
                        <form action="{{ url('/super/join') }}" method="post" id="join">
   ...
   window.setInterval(function(){
            ...
            $.ajax({
                ...
                type: 'get',
                url: '{{ URL::to('/super/admin_messages') }}',
                data: {
                    'msgid': msg_id
                },
            ...
            $("#update_user").submit(function(e) {
                    ...
                    $.ajax({
                        url: '{{URL::to('/super/update_user_by_wsa')}}',
                        type: 'POST',
                        dataType: 'JSON',
                        data: form.serialize(),
                        success: function (data) {
            ...
            window.setInterval(function(){
                ...
                for (i = 0; i < count ; i++) {
                    ...
                    $.ajax({
                        ...
                        type: 'get',
                        async: false,
                        url: '{{ URL::to('/super/count_man_unread') }}',
                        data: {
                        'msg_id': msg_id
                        },
                        success: function(data){
