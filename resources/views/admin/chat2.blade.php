                        ...
                        <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon feather icon-shopping-cart"></i><span class="badge badge-pill badge-primary badge-up cart-item-count">6</span></a>
                            <ul class="dropdown-menu dropdown-menu-media dropdown-cart dropdown-menu-right">
                                ...
                                <li class="scrollable-container media-list"><a class="cart-item" href="app-ecommerce-details.html">
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img src="{{ asset('admin/app-assets/images/pages/eCommerce/4.png')}}" width="75" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img class="mt-1 pl-50" src="{{ asset('admin/app-assets/images/pages/eCommerce/dell-inspirion.jpg')}}" width="100" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img src="{{ asset('admin/app-assets/images/pages/eCommerce/7.png')}}" width="88" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img src="{{ asset('admin/app-assets/images/pages/eCommerce/10.png')}}" width="75" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img class="mt-1 pl-50" src="{{ asset('admin/app-assets/images/pages/eCommerce/sony-75class-tv.jpg')}}" width="100" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img class="mt-1 pl-50" src="{{ asset('admin/app-assets/images/pages/eCommerce/canon-camera.jpg')}}" width="70" alt="Cart Item"></div>
