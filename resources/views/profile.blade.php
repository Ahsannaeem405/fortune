        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control input" placeholder="Aktualne hasło" class="form-control @error('password') is-invalid @enderror" name="password">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control input" placeholder="nowe hasło" class="form-control @error('password') is-invalid @enderror" name="new_password">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control input" placeholder="Potwierdź hasło" class="form-control @error('password') is-invalid @enderror" name="confirm_password">
